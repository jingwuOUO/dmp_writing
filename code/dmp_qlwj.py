...
#             #fx = (up/down)*self.x[i]*math.exp(self.y[self.lenth-1]+0.2*(self.y[self.lenth-1]-self.y[0]) - self.y[0])
...
#             #ddy1[i] = self.alpha*(self.beta* (self.y[self.lenth-1]+0.2*(self.y[self.lenth-1]-self.y[0]) - plot_y[i-1]) - dy1[i-1]) - fx + self.x[i]*self.alpha*self.beta* (self.y[self.lenth-1]+0.2*(self.y[self.lenth-1]-self.y[0]) - self.y[0])
